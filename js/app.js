(() => {
    ...
    function initSliders() {
        if (document.querySelector(".personal-block__slider")) new core(".personal-block__slider", {
        ...
        if (document.querySelector(".licenses-block__slider")) new core(".licenses-block__slider", {
            modules: [ Navigation, Pagination, Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
        ...
        if (document.querySelector(".personals-block__slider")) new core(".personals-block__slider", {
            modules: [ Navigation, Pagination, Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".aboutClinic-block__slider")) new core(".aboutClinic-block__slider", {
            modules: [ Navigation, Pagination, Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
    ...
    class ScrollWatcher {
        ...
        scrollWatcherCallback(entry, observer) {
            ...
            if ("some value" === targetElement.dataset.watch) ;
            if (entry.isIntersecting) {
